...
function socialIcon(label: string): React.ReactElement {
  const key = label.toLowerCase().split(' / ')[0].replace(/\s/g, '');
...
export function StorefrontFooter() {
  ...
  if (b.footerEnabled === false) return null;   // merchant disabled the footer
